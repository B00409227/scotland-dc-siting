...
| Environmental burden | ✅ **Real** — SEPA ArcGIS API, % of river water bodies NOT at Good/High ecological status per sub-basin (Forth 83%, Clyde 72%, Tay 64%, NE Scotland 61%, Highland avg 30%, Argyll 54%) | [SEPA Water Classification Hub ArcGIS API](https://map.sepa.org.uk/server/rest/services/Open/Hydrography/MapServer/4) — Open Government Licence |
| Infrastructure reuse | ✅ **Real** — total derelict + urban vacant land (hectares) per council (Fife 698 ha, Highland 585 ha, Glasgow 781 ha, Argyll & Bute 48 ha) | [Scottish Vacant & Derelict Land Survey 2024 Table 2](https://www.gov.scot/publications/scottish-vacant-derelict-land-statistics-2024/) |
